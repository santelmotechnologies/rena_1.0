...
GList *
rena_dnd_library_get_mobj_list (GtkSelectionData *data, RenaDatabase *cdbase)
{
...
GList *
rena_dnd_uri_list_get_mobj_list (GtkSelectionData *data)
{
	RenaMusicobject *mobj = NULL;
...
GList *
rena_dnd_plain_text_get_mobj_list (GtkSelectionData *data)
{
	RenaMusicobject *mobj = NULL;
	gchar *filename = NULL;
	GList *list = NULL;
