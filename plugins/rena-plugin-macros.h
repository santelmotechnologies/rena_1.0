 ...
 *
 * Plugin engine for Totem, adapted to Rena, heavily based on the code from
...
#ifndef __RENA_PLUGIN_H__
#define __RENA_PLUGIN_H__
 ...
 *
 * Registers a plugin with the Rena plugin system, including registering the type specified in the parameters and declaring its activate and
...
#define _REGISTER_PRIVATE_CODE(TYPE_NAME, TypeName, type_name, TYPE_CODE, REGISTER_CODE)	\
	static void rena_plugin_activate (PeasActivatable *plugin);		\
	static void rena_plugin_deactivate (PeasActivatable *plugin);	\
	...
	{									\
		iface->activate = rena_plugin_activate;			\
		iface->deactivate = rena_plugin_deactivate;			\
	}									\
	static void								\
...
/**
 * RENA_PLUGIN_REGISTER_PUBLIC_HEADER:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
 ...
 * deactivate functions.
 **/
#define RENA_PLUGIN_REGISTER_PUBLIC_HEADER(TYPE_NAME, TypeName, type_name)	\
	_REGISTER_PUBLIC_HEADER(TYPE_NAME, TypeName, type_name,,)

/**
 * RENA_PLUGIN_REGISTER_PRIVATE_CODE:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
 ...
 * deactivate functions.
 **/
#define RENA_PLUGIN_REGISTER_PRIVATE_CODE(TYPE_NAME, TypeName, type_name)	\
	_REGISTER_PRIVATE_CODE(TYPE_NAME, TypeName, type_name,,)

/**
 * RENA_PLUGIN_REGISTER:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
 ...
 * deactivate functions.
 **/
#define RENA_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name)			\
	_REGISTER_PUBLIC_HEADER(TYPE_NAME, TypeName, type_name,,)		\
	_REGISTER_PRIVATE_CODE(TYPE_NAME, TypeName, type_name,,)

/**
 * RENA_PLUGIN_REGISTER_CONFIGURABLE_PUBLIC_HEADER:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
 * Registers a configurable plugin with the Rena plugin system, including registering the type specified in the parameters and declaring its activate
...
#define RENA_PLUGIN_REGISTER_CONFIGURABLE_PUBLIC_HEADER(TYPE_NAME, TypeName, type_name)	\
	_REGISTER_CONFIGURABLE_PUBLIC_HEADER(TYPE_NAME, TypeName, type_name)
/**
 * RENA_PLUGIN_REGISTER_CONFIGURABLE_PRIVATE_CODE:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
...
#define _REGISTER_CONFIGURABLE_PRIVATE_CODE(TYPE_NAME, TypeName, type_name)	\
	static GtkWidget *rena_plugin_create_configure_widget (PeasGtkConfigurable *configurable); \
	...
	{									\
		iface->create_configure_widget = rena_plugin_create_configure_widget;	\
	}

#define RENA_PLUGIN_REGISTER_CONFIGURABLE_PRIVATE_CODE(TYPE_NAME, TypeName, type_name)	\
	_REGISTER_CONFIGURABLE_PRIVATE_CODE(TYPE_NAME, TypeName, type_name)

/**
 * RENA_PLUGIN_REGISTER_CONFIGURABLE:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
 ...
 * and deactivate and widget creation functions.
 **/
#define RENA_PLUGIN_REGISTER_CONFIGURABLE(TYPE_NAME, TypeName, type_name)	\
	_REGISTER_CONFIGURABLE_PUBLIC_HEADER(TYPE_NAME, TypeName, type_name)	\
	_REGISTER_CONFIGURABLE_PRIVATE_CODE(TYPE_NAME, TypeName, type_name)

G_END_DECLS

#endif  /* __RENA_PLUGIN_H__ */
