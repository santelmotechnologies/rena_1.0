...
static void
rena_text_info_dialog_response (GtkDialog *dialog,
                                  gint       response,
                                  gpointer   data)
{
...
void
rena_show_related_text_info_dialog (GtkWidget   *widget,
                                      ...
                                      const gchar *text)
{
	...
	rena_header_set_title (header, subtitle_header);
	...
	g_signal_connect (G_OBJECT(dialog), "response",
	                  G_CALLBACK(rena_text_info_dialog_response), NULL);
